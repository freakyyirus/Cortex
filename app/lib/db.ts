...
// NOTE: Solana base58 addresses are case-sensitive (they can contain A–Z), so
// addresses are stored/compared verbatim — no lowercasing.
...
export const db = {
  ...
  /**
   * Compensating store: a bounty was PAID for (x402 fee received on Solana) but

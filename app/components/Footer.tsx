    ...
    <footer className="relative w-full overflow-hidden border-t border-line">
      <div className="mx-auto flex max-w-content flex-col gap-10 px-6 py-12">
        <div className="flex flex-col items-start justify-between gap-10 md:flex-row">
          <div>
            ...
            <p className="max-w-xs text-xs leading-relaxed text-fg-muted">
              AI-powered bounty platform built on Solana.
          ...
          <div className="flex gap-16">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <Link href="https://solana.com" target="_blank" className="text-xs font-medium text-fg-muted transition-colors hover:text-fg">Solana</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between border-t border-line pt-6">
          <p className="text-[10px] font-medium tracking-tight text-fg-faint">© 2025 MonQuest. Built on Solana.</p>

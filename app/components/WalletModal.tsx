      ...
      <div className="relative w-full max-w-md card-elevated rounded-3xl p-6">
        ...
        <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50 p-4">
          <p className="text-sm font-medium text-amber-800">
            💡 To create bounties or pay winners, you need SOL in your wallet.
          </p>
          <p className="mt-1 text-xs text-amber-600">
            Send SOL to your wallet address above, or use a Solana faucet on devnet.
          </p>
        </div>
        ...
        <div className="space-y-3">
          <a
            href={getSolanaAddressExplorerUrl(walletAddress)}
            target="_blank"

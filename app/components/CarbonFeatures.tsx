...
const features = [
  {
    ...
    description:
      "Publishing costs a flat 0.001 SOL via the x402 payment protocol. The server returns HTTP 402 with payment details, your Solana wallet signs a native transfer, and the tx is verified on-chain before the bounty goes live.",
    tag: "Payments",
  },
  {
    icon: Brain,
  ...
  },
  {
    ...
    description:
      "Every payment is checked against the chain — recipient, amount, and status — for both the 0.001 SOL platform fee and the final winner payout.",
    tag: "Trust",
  },
  {
    icon: Zap,
    ...
    description:
      "When you pay a winner, the payout tx is verified on Solana before the bounty ever flips to PAID. No escrow, no custody, no middlemen.",
    tag: "Settlement",
  },
  {
    icon: KeyRound,
    title: "Native Solana Wallets",
    description:
      "Connect Phantom, Solflare, or Backpack straight from the app. Your SOL powers the fee and the prize — signed in your wallet, secured on-chain.",
    tag: "UX",
  },
  {
    icon: Globe,
    title: "Devnet-Ready",
    description:
      "Runs on Solana devnet out of the box — a faucet funds a test wallet in seconds, and the bonus wallets page reads EVM, SOL, and BTC balances.",
    tag: "Extras",
  },
];

...
const steps = [
  {
    ...
    title: "Post a Bounty",
    description:
      "Describe the task, set a prize in SOL, and settle a 0.001 SOL x402 fee. The server verifies the payment on Solana before your bounty goes live on the registry.",
    icon: Code,
  },
  {
    number: "02",
